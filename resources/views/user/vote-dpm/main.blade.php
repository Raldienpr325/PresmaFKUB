                ...
                <div class="col-lg-3 col-6 col-sm-6  ">
                    <div class="card "
                        ...
                        <div class="bg-image hover-overlay ripple" data-mdb-ripple-color="light">
                            <img src="{{ asset('storage/' . $data->fotodpm) }}" class="card-img-top" />
                            <a href="#!">
                        ...
                        <div class="card-body" style="text-align: center">
                            <h5 class="card-title">
                                <h3>{{ $data->namadpm }} ( {{ $data->nourutdpm }} )</h3>
                            </h5>
                            <p class="card-text"> Prodi {{ $data->prodidpm }} | Angkatan {{ $data->angkatandpm }}
                            </p>
                            <a
                                href="{{ url('user.done-vote2', [
                                    'usersid' => $data->id,
                                    'name' => Auth::user()->name,
                                ]) }}">
